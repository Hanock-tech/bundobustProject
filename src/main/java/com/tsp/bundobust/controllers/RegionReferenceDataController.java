...
public class RegionReferenceDataController {
	...
	public ResponseEntity<UIBaseResponse> getRegions(@Valid @RequestParam String districtName) {
		...
		//TODO: Fetch data from regions database and regions collection
	...
	public ResponseEntity<UIBaseResponse> getAllDistrictsAndCommisionerates(@Valid @RequestParam String districtName) {
